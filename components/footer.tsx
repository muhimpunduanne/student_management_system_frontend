  ...
  return (
    <footer className="relative overflow-hidden bg-black text-gray-300 border-t border-gray-700 py-12 px-6">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-wrap justify-between gap-8">
        ...
        <div className="flex-1 min-w-[220px] max-w-[320px]">
          ...
          <p className="text-sm leading-relaxed text-white">
            At Student Management Systems (SMS), we specialize in building
            advanced, scalable{" "}
            <strong className="text-indigo-500">
              Student Management Systems
            </strong>{" "}
            for educational institutions. From attendance tracking to results,
            scheduling, and parent-teacher communication, we help schools
            operate smarter and faster through technology.
          </p>
        </div>
        ...
        <div className="flex-1 min-w-[220px] max-w-[280px]">
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            <li className="flex items-center gap-2">
              <Phone size={18} /> +250 795 306 939
            </li>
            <li className="flex items-center gap-2">
              <Mail size={18} /> muhimpundan@gmail.com
            </li>
            <li className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-[280px] max-w-[320px]">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Join our newsletter for product updates, feature launches, and
            education tech tips.
          </p>
      ...
      <div className="relative z-10 mt-12 pt-8 border-t border-gray-700 flex flex-col sm:flex-row items-center justify-between max-w-7xl mx-auto text-sm text-white">
        <p>
          &copy; {new Date().getFullYear()} EduCore Systems. All rights
          reserved.
        </p>
